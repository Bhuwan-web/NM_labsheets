//a program to solve boundary value problem using shooting method.
#include<stdio.h>
#include<math.h>
#include<stdlib.h>
...
{
 printf("\n\t\t===================================================\n");
printf("\t\tBhuwan Panta\t\t Roll no.25720/077\n ");
 printf("\t\tImplement boundary value problem using shooting  method  \n\n");
system("color 71");
...
//     Enter the trial M1:7
//Enter the value of M2:3.5
